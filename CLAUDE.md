# CLAUDE.md - HomeScraper Developer & Agent Instructions

This document provides instructions, conventions, and architectural context for Claude and AI coding assistants working on the `HomeScraper` codebase.
